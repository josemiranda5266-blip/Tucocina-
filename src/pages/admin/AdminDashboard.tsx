    ...
    <div className="space-y-8">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard icon={<Search className="w-5 h-5" />} label="Búsquedas" value={totals.searches || 0} />
