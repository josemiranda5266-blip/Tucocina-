...
export const AppContent: React.FC = () => {
  ...
  const needsLegalAcceptance = Boolean(user && profile && profile.legalVersion !== CURRENT_LEGAL_VERSION);
  ...
  const renderView = () => {
    if (location.view === 'admin') {
      return <AdminLayout currentAdminTab={adminTab} onTabChange={handleAdminTabChange}>
